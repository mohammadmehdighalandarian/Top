...
namespace TopinLite.Biz.ChargeHandler.Youth
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<IYouthChargeValidationService, YouthChargeValidationService>();
            builder.Services.AddSingleton<IYouthConfirmOrderService, YouthConfirmOrderService>();
            ...
            builder.Services.AddSingleton(_ =>
            {
                var opts = NatsOpts.Default with
                {
                    ...
                    Name = "Biz.ChargeHandler.Youth.RequestOrder",
            ...
            builder.Services.AddSingleton(_ =>
            {
                ...
                {
                    Url = "nats://localhost:4222",
                    Name = "Biz.ChargeHandler.Youth.ConfirmOrder",
                    SerializerRegistry = NatsJsonSerializerRegistry.Default
                };
            ...
            app.MapGet("/Biz/ChargeHandler/Youth", () => "TopinLite.Biz.ChargeHandler.Youth is running.");
            app.Run();
        }
    }
}
