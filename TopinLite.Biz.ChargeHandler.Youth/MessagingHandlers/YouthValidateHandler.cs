...
namespace TopinLite.Biz.ChargeHandler.Youth.MessagingHandlers
{
    public sealed class YouthValidateHandler
        : IRpcHandler<ChargeTypeValidateRequest, ChargeTypeValidateResponse>
    {
        private readonly IYouthChargeValidationService _validation;
 
        public YouthValidateHandler(IYouthChargeValidationService validation)
        {
