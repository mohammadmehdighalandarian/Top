...
using TopinLite.CrmTransform.QuerySimType.MessagingHandlers;
...
public static class ServiceDependencyInjection
{
    ...
    public static IServiceCollection AddDependentServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddNatsRpcFoundation(
                         ...
                         configure: rpc =>
                         {
                             rpc.AddHandler<QuerySimTypeHandler, QuerySimTypeRequestModel, QuerySimTypeResponseModel>(subject: "crm.querysimtype", maxConcurrency: 128);
                         });
