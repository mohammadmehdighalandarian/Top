...
using TopinLite.CrmTransform.RechargeByBroker.MessagingHandlers;
...
namespace TopinLite.CrmTransform.RechargeByBroker.ServiceExtentions
{
    public static class ServiceDependencyInjection
    {
        ...
        {
            services.TryAddSingleton<Infra.MsBroker.RabbitMQ.IRabbitMQBroker, Infra.MsBroker.RabbitMQ.Loggers.RabbitMqBroker>();
            ...
            services.AddNatsRpcFoundation(
                             ...
                             configure: rpc =>
                             {
                                 rpc.AddHandler<RechargeByBrokerHandler, RechargeByBrokerRequestModel, RechargeByBrokerResponseModel>(subject: "crm.rechargebybroker", maxConcurrency: 128);
                             });
