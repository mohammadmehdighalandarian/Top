...
using TopinLite.CrmTransform.QueryCustomerInfoByTel.MessagingHandlers;
...
public static class ServiceDependencyInjection
{
    ...
    public static IServiceCollection AddDependentServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddNatsRpcFoundation(
                         ...
                         configure: rpc =>
                         {
                             rpc.AddHandler<QueryCustomerByTelHandler, QueryCustomerByTelRequestModel, QueryCustomerByTelResponseModel>(subject: "crm.querycustomerinfobytel", maxConcurrency: 128);
                         });
