...
using TopinLite.CrmTransform.IntegrationEnquery.MessagingHandlers;
    ...
    public static class ServiceDependencyInjection
    {
        ...
        public static IServiceCollection AddDependentServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddNatsRpcFoundation(
                             ...
                             configure: rpc =>
                             {
                                 rpc.AddHandler<IntegrationEnqueryHandler, IntegrationEnqueryRequestModel, IntegrationEnqueryResponseModel>(subject: "crm.integrationenquery", maxConcurrency: 128);
                             });
