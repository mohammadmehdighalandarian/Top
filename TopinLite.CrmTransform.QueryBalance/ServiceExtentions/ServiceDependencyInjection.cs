...
using TopinLite.CrmTransform.QueryBalance.MessagingHandlers;
    ...
    public static class ServiceDependencyInjection
    {
        ...
        public static IServiceCollection AddDependentServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddNatsRpcFoundation(
                             ...
                             configure: rpc =>
                             {
                                 rpc.AddHandler<QueryBalanceHandler, QueryBalanceRequestModel, QueryBalanceResponseModel>(subject: "crm.querybalance", maxConcurrency: 128);
                             });
