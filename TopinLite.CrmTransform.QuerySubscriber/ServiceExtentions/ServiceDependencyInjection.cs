...
using TopinLite.CrmTransform.QuerySubscriber.MessagingHandlers;
    ...
    public static class ServiceDependencyInjection
    {
        ...
        public static IServiceCollection AddDependentServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddNatsRpcFoundation(
                             ...
                             configure: rpc =>
                             {
                                 rpc.AddHandler<QuerySubscriberHandler, QuerySubscriberRequestModel, QuerySubscriberResponseModel>(subject: "crm.querysubscriber", maxConcurrency: 128);
                             });
