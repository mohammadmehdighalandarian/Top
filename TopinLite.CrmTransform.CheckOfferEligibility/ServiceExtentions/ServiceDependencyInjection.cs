...
using TopinLite.CrmTransform.CheckOfferEligibility.MessagingHandlers;
    ...
    public static class ServiceDependencyInjection
    {
        ...
        public static IServiceCollection AddDependentServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddNatsRpcFoundation(
                             ...
                             configure: rpc =>
                             {
                                 rpc.AddHandler<CheckOfferEligibilityHandler, CheckOfferEligibilityRequestModel, CheckOfferEligibilityResponseModel>(subject: "crm.checkoffereligibility", maxConcurrency: 128);
                             });
