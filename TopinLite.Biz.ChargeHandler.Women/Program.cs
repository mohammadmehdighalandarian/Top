...
namespace TopinLite.Biz.ChargeHandler.Women
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<IWomenChargeValidationService, WomenChargeValidationService>();
            builder.Services.AddSingleton<IWomenConfirmOrderService, WomenConfirmOrderService>();
            ...
            app.MapGet("/Biz/ChargeHandler/Women", () => "TopinLite.Biz.ChargeHandler.Women is running.");
            app.Run();
        }
    }
}
