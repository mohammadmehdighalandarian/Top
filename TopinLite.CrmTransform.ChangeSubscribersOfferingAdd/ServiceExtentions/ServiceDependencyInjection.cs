...
using TopinLite.CrmTransform.ChangeSubscribersOfferingAdd.MessagingHandlers;
    ...
    public static class ServiceDependencyInjection
    {
        ...
        public static IServiceCollection AddDependentServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddNatsRpcFoundation(
                             ...
                             configure: rpc =>
                             {
                                 rpc.AddHandler<ChangeSubscribersOfferingAddHandler, ChangeSubscribersOfferingAddRequestModel, ChangeSubscribersOfferingAddResponseModel>(subject: "crm.changesubscribersofferingadd", maxConcurrency: 128);
                             });
