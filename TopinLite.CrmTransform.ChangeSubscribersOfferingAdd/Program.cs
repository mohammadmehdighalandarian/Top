...
namespace TopinLite.CrmTransform.ChangeSubscribersOfferingAdd
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            app.MapPost("/ChangeSubscribersOfferingAdd",
                    async (HttpContext httpContext, [FromServices] IMediator _mediator, [FromBody] ChangeSubscribersOfferingAddTcpRequest model) =>
                    {
