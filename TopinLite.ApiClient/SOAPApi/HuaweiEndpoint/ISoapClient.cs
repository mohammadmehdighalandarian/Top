...
namespace TopinLite.Infra.ApiClient.SOAPApi.HuaweiEndpoint
{
    public interface ISoapClient
    {
        ...
        Task<TopinLite.Domain.HuaweiApiModel.CRMResponses.Recharge.EnvelopeRechargeResponse> RechargeByBroker(string PrimaryIdentity, decimal Amount, string Mss, string BrokerId, string RechargeChannelId, string TradeType, string BeId);
