...
namespace TopinLite.Infra.ApiClient.SOAPApi.HuaweiEndpoint
{
    public interface IEndpoint
    {
        ...
        Task<GeneralHuawiResponse> QuerySubscriber(QuerySubscriberTcpRequest model);
    ...
    public class Endpoint : IEndpoint
    {
        ...
        public async Task<GeneralHuawiResponse> QuerySubscriber(QuerySubscriberTcpRequest model)
        {
            ...
            return new GeneralHuawiResponse<QuerySubscriberResponse> { ResponseType = "0", ResponseDesc = responseDesc };
        }
